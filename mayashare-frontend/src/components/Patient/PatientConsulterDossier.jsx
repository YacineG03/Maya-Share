          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 2 }}>
            ...
            <Box sx={{ display: "flex", gap: 1 }}>
              <Tooltip title="Télécharger">
                <IconButton onClick={handleDownload} size="small" sx={{ color: colors.primary }}>
                  <DownloadIcon />
                </IconButton>
              </Tooltip>
      ...
      <Fade in={open}>
        <Box sx={modalStyle}>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <Box hidden={activeTab !== 0} sx={{ p: 2, bgcolor: colors.background, borderRadius: 2 }}>
              <Typography
                variant="body1"
                sx={{
                  color: colors.text,
...
const PatientConsulterDossier = () => {
  ...
  const filteredDossiers = dossiers.filter((dossier) => {
    const searchMatch =
      searchTerm === "" ||
      (dossier.diagnostic && dossier.diagnostic.toLowerCase().includes(searchTerm.toLowerCase())) ||
      (dossier.traitement && dossier.traitement.toLowerCase().includes(searchTerm.toLowerCase())) ||
      (dossier.medecinNom && dossier.medecinNom.toLowerCase().includes(searchTerm.toLowerCase()))
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 4 }, bgcolor: colors.background, minHeight: "100vh", overflow: "auto" }}>
      <motion.div variants={containerVariants} initial="hidden" animate="visible">
        <Box sx={{ display: "flex", alignItems: "center", mb: 4, gap: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mt: 0.5 }}>
              {filteredDossiers.length} dossier{filteredDossiers.length !== 1 ? "s" : ""} disponible
        ...
        {filteredDossiers.length === 0 ? (
          ...
          >
            <LocalHospitalIcon sx={{ fontSize: 60, color: colors.textSecondary, opacity: 0.5, mb: 2 }} />
            <Typography variant="h6" color={colors.textSecondary} sx={{ mb: 2 }}>
              {searchTerm ? "Aucun dossier ne correspond à votre recherche." : "Aucun dossier médical trouvé."}
            </Typography>
            {searchTerm && (
              <motion.div whileHover="hover" whileTap="tap" variants={buttonVariants}>
                <Button
                        ...
                        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                          ...
                          <Box>
                            ...
                            <Typography variant="body2" sx={{ color: colors.textSecondary }}>
                              Dossier créé le: {formatDate(dossier.dateCreation)}
                            </Typography>
                          </Box>
                          <Chip
                            label={dossier.etat}
                        ...
                        {isExpanded && (
                          <motion.div variants={expandVariants} initial="hidden" animate="visible" exit="exit">
                                ...
                                <Box sx={{ bgcolor: colors.background, p: 2, borderRadius: 2 }}>
                                  ...
                                  <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                                    ...
                                    <Typography variant="body2" sx={{ color: colors.text }}>
                                      <strong>Email:</strong> {dossier.email || "Non spécifié"}
                                    </Typography>
                                  </Box>
                                  <Box sx={{ display: "flex", alignItems: "center" }}>
                                    <Typography variant="body2" sx={{ color: colors.text }}>
                                      <strong>Téléphone:</strong> {dossier.telephone || "Non spécifié"}
                                    </Typography>
                                  </Box>
                                </Box>
                              </Grid>
                              <Grid item xs={12} md={6}>
                                <Box sx={{ bgcolor: colors.background, p: 2, borderRadius: 2 }}>
                                  ...
                                  <Box sx={{ display: "flex", alignItems: "flex-start" }}>
                                    <LocalHospitalIcon sx={{ color: colors.primary, mr: 1, fontSize: 20, mt: 0.5 }} />
                                    <Box>
                                      <Typography variant="body2" sx={{ color: colors.text, fontWeight: 500 }}>
                                        Traitement:
                                      </Typography>
                            ...
                            <Box sx={{ mb: 2 }}>
                              ...
                              >
                                <Tab label="Consultations" icon={<EventNoteIcon />} iconPosition="start" />
                                <Tab label="Médecin" icon={<PersonIcon />} iconPosition="start" />
                              </Tabs>
                              ...
                              <Box hidden={activeTab !== 0}>
                                {dossier.consultations && dossier.consultations.length > 0 ? (
                                              ...
                                              return (
                                                <Grid item xs={12} sm={6} md={4} key={fichier.idImage}>
                                                  ...
                                                  >
                                                    ...
                                                    <VisibilityIcon fontSize="small" sx={{ color: colors.primary }} />
                                                  </Paper>
                                                </Grid>
                                              )
                                            })}
                                  ...
                                  >
                                    <EventNoteIcon
                                      sx={{ fontSize: 40, color: colors.textSecondary, opacity: 0.5, mb: 1 }}
                                    />
                              ...
                              <Box hidden={activeTab !== 1}>
                                ...
                                >
                                  <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
                                    ...
                                    <Box>
                                      <Typography variant="h6" sx={{ fontWeight: 600, color: colors.text }}>
                                        {dossier.medecinNom || "Médecin non assigné"}
                                      </Typography>
                                      <Typography variant="body2" color={colors.textSecondary}>
                                        {dossier.medecinSpecialite || "Spécialité non spécifiée"}
                                      </Typography>
                                    </Box>
                                  </Box>
                                  <Divider sx={{ my: 2 }} />
                                  <Typography variant="body2" color={colors.textSecondary}>
                                    <strong>Email:</strong> {dossier.medecinEmail || "Non spécifié"}
                                  </Typography>
                                  <Typography variant="body2" color={colors.textSecondary}>
                                    <strong>Téléphone:</strong> {dossier.medecinTelephone || "Non spécifié"}
                                  </Typography>
                                </Paper>
                              </Box>
                            </Box>
