        ...
        <Grid
          ...
          sx={{
            ...
            '&::before': {
              ...
              bottom: 0,
              backgroundImage:
                'radial-gradient(circle at 30% 20%, rgba(0, 120, 215, 0.1) 0%, rgba(255, 255, 255, 0) 70%)',
              zIndex: -1,
            },
          }}
        >
                ...
                >
                  <HealthIcon
                    sx={{
                      ...
                      color: '#0078D7',
                      filter:
                        'drop-shadow(0px 0px 10px rgba(0, 120, 215, 0.5))',
                    }}
                  />
                </Box>
              </motion.div>
        ...
        <Grid
          ...
          sx={{
            ...
            '&::before': {
              ...
              bottom: 0,
              backgroundImage:
                'radial-gradient(circle at 70% 30%, rgba(255, 255, 255, 0.15) 0%, rgba(0, 120, 215, 0) 70%)',
              zIndex: 0,
            },
            '&::after': {
              content: '""',
