        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box>
            ...
            <Typography variant='body1' sx={{ color: colors.textSecondary }}>
              {dataFetched ? `${filteredRendezVous.length} rendez-vous ${filter !== 'tous' ? filter + 's' : ''}` : 'Appuyez sur Rafraîchir pour charger'}
            </Typography>
          </Box>
        </Box>
        ...
        >
          ...
          >
            ...
            <Typography
              ...
              sx={{ mb: 2 }}
            >
              Veuillez cliquer sur le bouton Rafraîchir pour charger les rendez-vous
            </Typography>
            <motion.div
              whileHover='hover'
              whileTap='tap'
