        ...
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="body1" sx={{ color: colors.textSecondary }}>
              {filteredRendezVous.length} rendez-vous {filter !== "tous" ? filter + "s" : ""}
            </Typography>
          </Box>
        </Box>
        ...
        <Tab
          ...
          icon={
            <Badge
              ...
              color="warning"
              sx={{ "& .MuiBadge-badge": { fontSize: "0.7rem", height: 18, minWidth: 18, bgcolor: colors.warning } }}
            />
          }
          iconPosition="end"
        />
        <Tab
          ...
          icon={
            <Badge
              ...
              color="success"
              sx={{ "& .MuiBadge-badge": { fontSize: "0.7rem", height: 18, minWidth: 18, bgcolor: colors.success } }}
            />
          }
          iconPosition="end"
        />
        <Tab
          ...
          icon={
            <Badge
              ...
              color="error"
              sx={{ "& .MuiBadge-badge": { fontSize: "0.7rem", height: 18, minWidth: 18, bgcolor: colors.error } }}
            />
          }
          iconPosition="end"
        />
      ...
      {loading ? (
        ...
        >
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <EventAvailableIcon sx={{ fontSize: 80, color: colors.textSecondary, opacity: 0.3, mb: 2 }} />
        ...
        <Grid container spacing={3}>
          {filteredRendezVous.map((rdv, index) => (
            <Grid item xs={12} md={6} lg={4} key={rdv.idRendezVous}>
              <motion.div custom={index} variants={cardVariants} initial="hidden" animate="visible" whileHover="hover">
                <Card
                  elevation={expandedRdv?.idRendezVous === rdv.idRendezVous ? 3 : 1}
                  sx={{
                    borderRadius: 3,
                    overflow: "hidden",
                ...
                >
                  <Box
                    sx={{
                      ...
                      cursor: "pointer",
                      bgcolor: expandedRdv?.idRendezVous === rdv.idRendezVous ? colors.infoLight : "white",
                    }}
                  ...
                  <Collapse in={expandedRdv?.idRendezVous === rdv.idRendezVous}>
                    <CardContent sx={{ pt: 0 }}>
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5 }}>
                        ...
                        <Box>
                          ...
                          <Typography
                            variant="body2"
                            sx={{ fontWeight: 500, bgcolor: colors.background, p: 1.5, borderRadius: 2 }}
                          >
                        ...
                        {rdv.commentaire && (
                          <Box>
                            ...
                            <Box sx={{ display: "flex", gap: 1, bgcolor: colors.background, p: 1.5, borderRadius: 2 }}>
                              <CommentIcon sx={{ color: colors.textSecondary, fontSize: 18, mt: 0.3 }} />
                              <Typography variant="body2">{rdv.commentaire}</Typography>
                            </Box>
                          </Box>
                        )}
                      </Box>
                    ...
                    <CardActions sx={{ p: 2, pt: 0, justifyContent: "flex-end", mt: "auto" }}>
                      {rdv.etat === "en attente" && (
                        <>
                          <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                            <Button
                              ...
                              sx={{
                                ...
                                "&:hover": { bgcolor: colors.success, filter: "brightness(0.9)" },
                                borderRadius: 2,
                                textTransform: "none",
                                fontWeight: 500,
                              }}
                          ...
                          <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                            <Button
                              ...
                              sx={{
                                ...
                                color: colors.error,
                                "&:hover": { borderColor: colors.error, bgcolor: colors.errorLight },
                                borderRadius: 2,
                                textTransform: "none",
                                fontWeight: 500,
                                ml: 1,
      ...
      >
        ...
        <DialogContent>
          <DialogContentText sx={{ mb: 2 }}>
            ...
            {actionType === "delete" && `Voulez-vous supprimer ce rendez-vous ? Cette action est irréversible.`}
          </DialogContentText>
        ...
        <DialogActions sx={{ px: 3, pb: 3 }}>
          ...
          <Button
            ...
            sx={{
              ...
              "&:hover": {
                bgcolor: actionType === "delete" ? colors.error : colors.secondary,
