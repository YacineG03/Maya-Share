...
// Partages
export const shareDossier = (idDossier, data) =>
  api.post('/shares/dossier', data);
...
export const getSharedAgendasForInfirmier = () =>
  api.get('/rendezvous/shared-agendas/infirmier');
